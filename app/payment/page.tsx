...
export default function PaymentPage() {
  ...
  const handleConfirmPayment = async (e: React.FormEvent) => {
    ...
    const generatedReceipt =
      "BIS-" + Math.floor(100000 + Math.random() * 900000);
          ...
          <div className="max-w-xl mx-auto mb-12 print:hidden">
            <div className="flex items-center justify-between relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm border-2 transition-all duration-300 ${currentStep >= 1 ? "bg-gradient-to-br from-yellow-400 to-orange-500 border-orange-400 text-slate-900 shadow-md shadow-orange-500/10" : "bg-white border-slate-200 text-slate-400"}`}
                >
                  1
                </div>
                <span
                  className={`text-[10px] font-bold mt-2 uppercase tracking-wider ${currentStep >= 1 ? "text-slate-800" : "text-slate-400"}`}
                >
                  Student Info
                </span>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm border-2 transition-all duration-300 ${currentStep >= 2 ? "bg-gradient-to-br from-yellow-400 to-orange-500 border-orange-400 text-slate-900 shadow-md shadow-orange-500/10" : "bg-white border-slate-200 text-slate-400"}`}
                >
                  2
                </div>
                <span
                  className={`text-[10px] font-bold mt-2 uppercase tracking-wider ${currentStep >= 2 ? "text-slate-800" : "text-slate-400"}`}
                >
                  Scan & Pay
                </span>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm border-2 transition-all duration-300 ${currentStep >= 3 ? "bg-gradient-to-br from-yellow-400 to-orange-500 border-orange-400 text-slate-900 shadow-md shadow-orange-500/10" : "bg-white border-slate-200 text-slate-400"}`}
                >
                  3
                </div>
                <span
                  className={`text-[10px] font-bold mt-2 uppercase tracking-wider ${currentStep >= 3 ? "text-slate-800" : "text-slate-400"}`}
                >
                  Receipt
                </span>
              </div>
              ...
              >
                <div className="mb-8 text-center sm:text-left">
                  ...
                  <p className="text-slate-500 text-sm">
                    Enter the student details to register your payment request.
                    A confirmation email will be sent to the school office.
                  </p>
                </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        value={parentMobile}
                        onChange={(e) =>
                          setParentMobile(e.target.value.replace(/[^0-9]/g, ""))
                        }
                        className="w-full bg-slate-50 border border-slate-200/80 rounded-2xl px-4 py-3.5 text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all"
                      />
                    </div>
              ...
              >
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-4 flex gap-3 text-slate-800 max-w-3xl mx-auto items-center">
                  ...
                  <p className="text-xs font-semibold leading-relaxed">
                    Student info logged successfully! Please scan the QR code
                    and enter the Transaction ID below to verify your receipt.
                  </p>
                </div>

                <div className="grid lg:grid-cols-12 gap-8 items-start">
                  {/* Left Column: QR Scan Card (Col 7) */}
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden flex flex-col sm:flex-row gap-6 items-center">
                      ...
                      <div className="space-y-3 flex-grow text-center sm:text-left">
                        ...
                        <p className="text-slate-500 text-xs leading-relaxed max-w-xs">
                          Scan the QR code using Google Pay, PhonePe, Paytm,
                          BHIM, or any banking app to make your payment of{" "}
                          <strong>
                        ...
                        <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 max-w-sm flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-slate-800 font-bold font-mono text-xs mt-0.5">
                              {bankDetails.upiId}
                            </p>
                          </div>
                          <button
                            onClick={() =>
                              copyToClipboard(bankDetails.upiId, "upi")
                            }
                  ...
                  <div className="lg:col-span-5 bg-white rounded-[2.5rem] p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
                    <div className="mb-6">
                      ...
                      <p className="text-slate-500 text-xs mt-1">
                        Input details of your transfer below to generate your
                        downloadable school fee slip.
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleConfirmPayment} className="space-y-4">
                      ...
                      <label className="flex items-start gap-3 cursor-pointer select-none py-1">
                        ...
                        <span className="text-xs text-slate-500 font-medium leading-relaxed">
                          ...
                          {parseFloat(amount).toLocaleString("en-IN")} via QR
                          scan / bank transfer to the school's account.
                        </span>
                      </label>
            ...
            {currentStep === 3 && (
              ...
              >
                ...
                <p className="text-slate-500 text-sm max-w-md mx-auto mb-8 print:hidden">
                  A receipt notification with details has been dispatched to the
                  school email. Please print or download this receipt for your
                  records.
                </p>
                ...
                <div className="bg-slate-50 rounded-3xl p-6 md:p-8 border border-slate-100 text-left mb-8 print:bg-white print:border-slate-300 print:text-black print:p-4">
                  <div className="flex justify-between items-start border-b border-slate-200 pb-6 mb-6">
                    <div>
                      ...
                      <p className="text-slate-500 text-[10px] mt-1 leading-relaxed">
                        Smt. Kamini Complex near Dakbangla Chauk,
                        <br />
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-6 text-xs mb-6 pb-6 border-b border-slate-200">
                    ...
                    <div>
                      ...
                      <p className="text-slate-800 font-extrabold text-sm mt-0.5">
                        Class {studentClass} - {classSection}
                      </p>
                    </div>
                    <div>
                      <p className="text-slate-400 font-bold uppercase tracking-wider">
                    ...
                    <div className="col-span-2">
                      <p className="text-slate-400 font-bold uppercase tracking-wider">
                        UPI / Net Banking Transaction ID
                      </p>
                      <p className="text-slate-800 font-mono font-bold text-sm mt-0.5 text-indigo-600">
                        {transactionId}
                      </p>
                    </div>
                  </div>
